          ...
          <div class="card-body">
            <form @submit.prevent="calculate()" novalidate>
              ...
              <div class="row g-2 mb-3">
                <div class="col-md-6">
                  <label for="start_date" class="form-label">Başlangıç ayı</label>
                  <input type="month" class="form-control" id="start_date" x-model="form.start_date" min="2020-01" :max="thisMonth" required>
                </div>
                <div class="col-md-6">
                  <label for="end_date" class="form-label">Hedef ay</label>
                  <input type="month" class="form-control" id="end_date" x-model="form.end_date" min="2020-01" :max="thisMonth" required>
                </div>
              </div>

              <div class="mb-3">
                <label for="start_price" class="form-label">Başlangıç fiyatı (₺)</label>
                <div class="input-group">
                  <span class="input-group-text">₺</span>
                  <input type="text" inputmode="decimal" class="form-control mono" id="start_price" x-model="form.start_price" placeholder="Örn: 5.000,00" required>
                </div>
              </div>
            ...
            <template x-if="result">
              <div>
                ...
                <div class="bg-white border rounded p-2">
                  <canvas id="inflChart" height="160"></canvas>
                </div>
              </div>
            </template>
          </div>
...
function inflationApp() {
  return {
    ...
    drawChart() {
      ...
      const canvas = document.getElementById('inflChart');
